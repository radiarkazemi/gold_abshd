    ...
    <div className="expert">
      <div className="expert__intro">
        ...
        <p className="expert__hint">
          ...
          تاییدشدهٔ <b>امروز</b> را هم تهاتر می‌کند (مثلاً ۲۰ تایید + ۳۰ در انتظار ← ۱۰ مانده). بعد از پوشش تهران همه صفر می‌شود.
          ماندهٔ روزهای قبل در «گزارش روزهای قبل» است و به امروز منتقل نمی‌شود.
        </p>
      </div>
