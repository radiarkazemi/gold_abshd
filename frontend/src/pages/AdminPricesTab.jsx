  ...
  return (
    <div className="admin-prices">
      ...
      <p className="price-cards-admin__hint">
        ...
        کارت‌های «متفرقه» و «نقد کارتخوان» قیمت را از آیتم id:1 می‌گیرند (نقد کارتخوان = id:1 + ۱۰۰٬۰۰۰ تومان)؛ کارمزد/اختلاف را از همین صفحه برای هر دسته‌بندی تنظیم کنید.
      </p>
                ...
                <p className="price-cards-admin__manual-note">
                  {c.goldbridge_item_id === 900001
                    ...
                    : c.goldbridge_item_id === 900002
                      ? "نقد کارتخوان: قیمت پایه = بخریدِ id:1 + ۱۰۰٬۰۰۰ تومان."
