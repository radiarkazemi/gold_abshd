...
class Settings:
    ...
    # Which weekdays are non-trading days, as Python weekday() numbers
    # (Monday=0 ... Sunday=6). Default: Thursday+Friday (3,4) - this
    # business is closed both days, not just Friday.
    WEEKEND_DAYS: str = os.getenv("GOLDAPP_WEEKEND_DAYS", "3,4")
    ...
    # the admin "all prices" dashboard, not the live trading price.
